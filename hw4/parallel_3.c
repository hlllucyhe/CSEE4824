// parallel.c - OpenMP parallel merge sort with timing and RSS measurement
#include <stdio.h>
#include <stdlib.h>
#include <omp.h>
#include <sys/resource.h>

#define THRESHOLD 50000   // tune this experimentally
...
#pragma omp single
        {
            mergeSort_parallel(arr, 0, (int)size - 1);
        }
    }
